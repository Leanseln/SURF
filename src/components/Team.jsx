...
function Team() {
  ...
  return (
    <section id='team' className='py-8 md:py-16 flex items-center'>
      <div className='container mx-auto'>
        <div>
        <h3 className='font-semibold text-center text-blue-600 uppercase tracking-wide text-xs'>WHO WE ARE</h3>
        <h2 className='text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-center text-blue-800'>Meet the Team</h2>
        <p className='text-xs sm:text-sm md:text-base text-gray-600 text-center max-w-3xl mx-auto px-2'>Our diverse team of experts is dedicated to revolutionizing flood rescue operations with 
            cutting-edge AI and robotics technology.</p>
      </div>
     
      <div className='grid grid-cols-2 sm:grid-cols-4 gap-4 my-6 px-2 md:px-10'>
        {teamMembers.map((member, index) => (
          <div key={index} className='text-center space-y-3 group bg-white p-4 rounded-lg shadow-sm mx-3 sm:mx-5'> 
